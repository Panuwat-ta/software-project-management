...
> หลักธรรมาภิบาลทางการเงิน: เมื่อ CCB มีมติ **Approved** ให้เพิ่มงาน CR-02 PM ต้องตัดยอดจาก **Contingency Reserve (ที่ตั้งไว้ใน Week 7 Cost Baseline)** มาจ่ายค่าแรง 4.5 ชม. และบันทึกอย่างโปร่งใสลงใน **Contingency Reserve Utilization Log** เพื่อให้ตรวจสอบได้ในการทำ Audit ท้ายโครงการ

## กติกาเบิกใช้ (Reserve Drawdown Rules)
- เบิกใช้ได้เฉพาะเมื่อ CCB มีมติ **Approve** เท่านั้น; **Defer / Reject = ไม่เบิก**
- เบิกจากเงินสำรองที่ตั้งไว้ใน Week 7 Cost Baseline เพื่อจ่ายงาน CR-02 (4.5 ชม. @ 300 บาท = 1,350 บาท)
